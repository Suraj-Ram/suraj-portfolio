  ...
  return (
    <div className="max-w-sm p-1 bg-gradient-to-tr from-cyan-400 to-green-500 mx-auto rounded-xl flex flex-col gap-2 mb-2 hover:shadow-lg  ">
      <div className="bg-white p-3 rounded-xl">
        ...
        <h4 className="text-xl font-bold mb-3 py-1">MNIST Web Serve</h4>
        <p className=" text-gray-700 text-base">
          Multiple Python Keras models, trained on the MNIST dataset, served on
          a interactive webpage through the use of Tensorflow JS for loading and
          getting predictions from the model and p5.js for canvas operations.
        </p>
        <TechStack />
